package com.example.javacv.test;
...
public class MainActivity extends Activity {
	...
	private String fileStr = "/mnt/sdcard/stream_test.flv";
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			if (isRecorderStart) {
				Toast.makeText(MainActivity.this, "isRecorderStart", 1000).show();
			} else {
    ...
    private void initRecorder() {
    	...
    	//recorder = new FFmpegFrameRecorder("rtmp://192.168.1.27:1935/livestream/12070660", width, height);
			...
			try {
				...
				while (isAudioRecording) {
					...
					if (bufferReadResult == 1024 && isRecorderStart) {
				    	...
				    	recorder.record(yuvIplimage, realAudioData1024);
						...
						for (int i = 0; i < 2; i++) {
							if (i == 0) {
								recorder.record(yuvIplimage, realAudioData2048_1);
							} else if (i == 1) {
								recorder.record(yuvIplimage, realAudioData2048_2);
							}
						}
